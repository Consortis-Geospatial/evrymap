...
- [Layer array](#layer-array)
 ...
 - [The projdef.json file](#the-projdef.json-file)
...
- **projection** : Optional. Required only if the layer is NOT in EPS:3857 or EPSG:4326 projection (which are included by default in OL). **IMPORTANT NOTE** If you set a projection then you will need to define the projection information in the `$root_folder/public/config/projdef.json` See also [The projdef.json file](#the-projdef.json-file)
